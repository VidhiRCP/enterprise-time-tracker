"use client";
                    <button
                      ...
                      className="text-xs text-[#808080] hover:text-[#D9D9D9] flex items-center gap-1"
                    >
                      <img src="/edit-icon.svg" alt="Edit" width={18} height={18} />
                      <span>Edit</span>
                    </button>
          ...
          {editingEntryId && (
            <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60">
              <div className="bg-black border border-[#808080]/30 p-4 w-full max-w-lg">
                <h3 className="font-bold mb-3">Edit Expense Entry</h3>
                <form className="space-y-4">
                  ...
                  <div className="flex items-center gap-3">
                    <button
                      ...
                      disabled={!form.projectId || isSaving}
